...
The function mutate() has leveled the Income Id in 4 levels from highghest to lowest, while also combats the waste from total waste per year to per capita.
...
The mutate manupulated the capita kg/yr and the income Id arranged in hierarchy.

5.  Describe in your own words what the 'color' argument inside the `aes()` does

aes() manipulated the color of the diffent income levels.

6.  Describe in your own words what the `labs()` function does

labs() is displaying the axis names.
...
3.  Write a meaningful commit message (e.g. "[Completed week 2 data science lifecycle homework](https://meet.google.com/bwp-jupy-xpv)") in the **Commit message** box
